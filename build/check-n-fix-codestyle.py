...
COPYRIGHT_PYTHON = '# Copyright (C) 2016-2018 Martin Dvorak <martin.dvorak@mindforger.com>'
COPYRIGHT_XML = '<!-- Copyright (C) 2016-2018 Martin Dvorak <martin.dvorak@mindforger.com> -->'
