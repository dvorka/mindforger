...
[Files]
Source: "..\..\..\\app\debug\mindforger.exe"; DestDir: "{app}\bin"; Flags: ignoreversion 64bit
Source: "{#VcRedistPath}"; DestDir: "{tmp}"; Flags: deleteafterinstall
Source: "..\..\..\app\debug\bin\*"; DestDir: "{app}\bin"; Flags: recursesubdirs
