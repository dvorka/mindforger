...
function buildDebPackage() {
    ...
    # CONFIG+=mfwebkit matches debian/control's libqt5webkit5-dev build-dep below -
    # Qt WebEngine is the project default, but this Debian packaging is still pinned
    # to the legacy Qt WebKit stack
