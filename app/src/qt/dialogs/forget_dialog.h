...
*/
#ifndef M8RUI_FORGET_DIALOG_H
#define M8RUI_FORGET_DIALOG_H
...
public:
    explicit ForgetDialog(QWidget* parent);
    ForgetDialog(const ForgetDialog&) = delete;
    ForgetDialog(const ForgetDialog&&) = delete;
    ForgetDialog &operator=(const ForgetDialog&) = delete;
    ForgetDialog &operator=(const ForgetDialog&&) = delete;
    ~ForgetDialog();
