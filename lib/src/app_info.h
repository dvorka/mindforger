...
#define MINDFORGER_VERSION_MINOR "2"
#define MINDFORGER_VERSION_REVISION "0"
#define MINDFORGER_VERSION_STRING "2.2.0"
#define MINDFORGER_VERSION_DWORD 2,2,0,2
...
#define MINDFORGER_APP_LEGAL "\xA9 2016-2026 Martin Dvorak. All Rights Reserved"
